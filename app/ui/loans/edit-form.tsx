...
import { BookField, StudentField, LoanForm } from '@/app/lib/definitions'; //done
import {
...
import { updateLoan } from '@/app/lib/actions'; //done
...
export default function EditLoanForm({
  ...
  const [state, dispatch] = useFormState(updateLoanWithId, initialState);
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={formatDateToLocal(loan.loan_date)}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="text"  
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                defaultValue= {formatDateToLocal(loan.return_date)}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pendente"
                  defaultChecked={loan.status === 'pendente'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="devolvido"
                  defaultChecked={loan.status === 'devolvido'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="devolvido"
